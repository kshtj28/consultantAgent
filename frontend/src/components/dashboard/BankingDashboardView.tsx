    ...
    if (!kpis) {
        return (
            <div className="banking-dashboard" style={{ alignItems: 'center', justifyContent: 'center', minHeight: '80vh' }}>
                <div style={{ textAlign: 'center', maxWidth: 520, padding: 40, background: 'var(--surface, white)', borderRadius: 16, boxShadow: 'var(--shadow-lg)', border: '1px solid var(--border, #e2e8f0)' }}>
                    ...
                    <p style={{ margin: '0 0 8px', fontSize: '0.9rem', color: 'var(--text-secondary, #64748b)', lineHeight: 1.5 }}>
                        KPIs are computed from gap reports generated by the data pipeline.
                        Finish (or pause) an interview with at least a few substantive
                        answers to trigger that pipeline.
                    </p>
                    <p style={{ margin: '0 0 24px', fontSize: '0.82rem', color: 'var(--text-secondary, #94a3b8)', lineHeight: 1.5 }}>
                        Already finished a session? The pipeline may have been interrupted —
                        admins can force a re-aggregation from existing data with the button below.
                    </p>
                    <div style={{ display: 'flex', gap: 10, justifyContent: 'center', flexWrap: 'wrap' }}>
                        ...
                        <RecomputeKpisButton variant="prominent" onComplete={onRecomputed} />
                    </div>
                </div>
            </div>
        );
